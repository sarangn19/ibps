...
async function seed() {
  ...
  try {
    ...
    const questions = [
      ...
      { subject: 'English Language', topic: 'Reading Comprehension', subtopic: 'Cloze Test', difficulty: 'medium', text: 'Fill in the blank: The government has _____ new measures to control inflation.', oa: 'announced', ob: 'announcing', oc: 'announce', od: 'announces', correct: 'a', expl: 'Present perfect requires past participle.', stage: 'prelims' },
      { subject: 'English Language', topic: 'Grammar', subtopic: 'Subject-Verb Agreement', difficulty: 'easy', text: 'Neither the teacher nor the students _____ present.', oa: 'was', ob: 'were', oc: 'is', od: 'has been', correct: 'b', expl: 'With "neither...nor", verb agrees with the nearest subject (students).', stage: 'prelims' },
      { subject: 'English Language', topic: 'Vocabulary', subtopic: 'Synonyms', difficulty: 'easy', text: 'Choose the synonym of "Benevolent":', oa: 'Cruel', ob: 'Kind', oc: 'Angry', od: 'Selfish', correct: 'b', expl: 'Benevolent means well-meaning, kindly.', stage: 'prelims' },
      { subject: 'English Language', topic: 'Vocabulary', subtopic: 'Antonyms', difficulty: 'easy', text: 'Choose the antonym of "Abundant":', oa: 'Plentiful', ob: 'Scarce', oc: 'Ample', od: 'Sufficient', correct: 'b', expl: 'Abundant means plentiful; scarce is opposite.', stage: 'prelims' },
      { subject: 'English Language', topic: 'Reading Comprehension', subtopic: 'Passage Based', difficulty: 'hard', text: 'Read: "The industrial revolution brought significant changes to society. It transformed how goods were produced and how people lived and worked." What was the primary impact?', oa: 'Political changes', ob: 'Social & economic transformation', oc: 'Cultural revival', od: 'Environmental damage', correct: 'b', expl: 'The passage mentions transformation of production, living, and working.', stage: 'mains' },
      { subject: 'English Language', topic: 'Grammar', subtopic: 'Tenses', difficulty: 'medium', text: 'She _____ (work) here since 2015.', oa: 'worked', ob: 'has been working', oc: 'was working', od: 'had worked', correct: 'b', expl: '"Since 2015" indicates action continuing from past to present.', stage: 'prelims' },
      { subject: 'English Language', topic: 'Sentence Correction', subtopic: 'Error Spotting', difficulty: 'medium', text: 'Find the error: "The team (A) are playing (B) well (C) today (D) No error."', oa: 'A', ob: 'B', oc: 'C', od: 'No error', correct: 'd', expl: 'Collective nouns can take plural verbs in British English.', stage: 'mains' },
      { subject: 'English Language', topic: 'Para Jumbles', subtopic: 'Sentence Ordering', difficulty: 'hard', text: 'Arrange: 1. It is a major economic activity. 2. India is an agricultural country. 3. Most people depend on farming. 4. The monsoon is crucial for crops.', oa: '2-1-3-4', ob: '2-3-1-4', oc: '3-2-1-4', od: '1-2-3-4', correct: 'b', expl: 'Main idea (2), support (3), conclusion (1), detail (4).', stage: 'mains' },
      { subject: 'English Language', topic: 'Vocabulary', subtopic: 'Idioms', difficulty: 'medium', text: 'What does "Hit the nail on the head" mean?', oa: 'To cause damage', ob: 'To work hard', oc: 'To describe exactly what is causing a situation', od: 'To fail', correct: 'c', expl: 'It means to describe exactly what is causing a situation.', stage: 'prelims' },
      { subject: 'English Language', topic: 'Grammar', subtopic: 'Prepositions', difficulty: 'easy', text: 'He is proficient _____ English.', oa: 'in', ob: 'at', oc: 'on', od: 'with', correct: 'a', expl: 'The correct preposition is "proficient in".', stage: 'prelims' },
